...
@pytest.fixture
def wall1():
    return Wall.from_outline_thickness(Polyline([[0, 0, 0], [0, 100, 0], [100, 100, 0], [100, 0, 0], [0, 0, 0]]), 10, normal=Vector.Zaxis(), name="wall1")


@pytest.fixture
def wall2():
    return Wall.from_outline_thickness(Polyline([[100, 0, 0], [100, 100, 0], [200, 100, 0], [200, 0, 0], [100, 0, 0]]), 10, normal=Vector.Zaxis(), name="wall2")


@pytest.fixture
def nameless_wall():
    return Wall.from_outline_thickness(Polyline([[100, 0, 0], [100, 100, 0], [200, 100, 0], [200, 0, 0], [100, 0, 0]]), 10, normal=Vector.Zaxis())
