...
if __name__ == "__main__":
    ...
    print(exec_times)
    plt.plot(model_sizes, [(t1-t0)*1000 for t0, t1, t2, t3 in exec_times], 'b', label='create beams')
    plt.plot(model_sizes, [(t2-t1)*1000 for t0, t1, t2, t3 in exec_times], 'g', label='add beams to assembly')
    plt.plot(model_sizes, [(t3-t2)*1000 for t0, t1, t2, t3 in exec_times], 'r', label='create joints explicitly')
