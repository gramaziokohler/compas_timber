...
def test__eq__():
        ...
        A1 = TimberAssembly()
        A2 = TimberAssembly()
        B1 = Beam().from_endpoints(Point(0,0,0), Point(2,0,0), 0.1, 0.2)
        B2 = Beam().from_endpoints(Point(1,0,0), Point(1,1,0), 0.1, 0.2)
        B3 = Beam().from_endpoints(Point(1,0,0), Point(1,1,0), 0.1, 0.2)
        B4 = Beam().from_endpoints(Point(1,0,0), Point(1,1,0), 0.1, 0.4)
        ...
        J1 = TButtJoint(A,B1,B2)
        J2 = TButtJoint(A,B1,B4)
        assert J1 != J2
