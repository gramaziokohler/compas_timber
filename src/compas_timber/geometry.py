...
def get_segment_range_on_polyline(segment: Line, polyline: Polyline, tol: float = 0.0) -> tuple[Point, Point]:
    ...
    tuple[:class:`~compas.geometry.Point`, :class:`~compas.geometry.Point`]
        A pair of points bounding the overlap of the polyline on the segment.
