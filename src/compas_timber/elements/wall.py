...
class WallOpeningType(object):
    DOOR = "door"
    WINDOW = "window"


class WallOpening(Data):
    @property
    def __data__(self):
        return {
    ...
    def __init__(self, polyline, opening_type, **kwargs):
        super(WallOpening, self).__init__(**kwargs)
        self.polyline = polyline
        self.opening_type = opening_type

    def __repr__(self):
        return "WallOpening(type={})".format(self.opening_type)
...
class Wall(TimberElement):
    ...
    def rotate(self):
        ...
        self.frame = Wall._frame_from_polyline(self.outline, self.frame.normal)
    ...
    def from_brep(cls, brep, thickness, **kwargs):
        ...
        for group in internal_groups:
            ...
            openings.append(WallOpening(Polyline(points), WallOpeningType.DOOR))
        ...
        for hole in face.holes:
            ...
            openings.append(WallOpening(Polyline(points), WallOpeningType.WINDOW))
