...
class FastenerTimberInterfaceComponent(Grasshopper.Kernel.GH_ScriptInstance):
    def RunScript(self, outline: Rhino.Geometry.Polyline, thickness: float, drill_points: System.Collections.Generic.List[Rhino.Geometry.Point3d], drill_diameters: System.Collections.Generic.List[float], extra_shapes: System.Collections.Generic.List[Rhino.Geometry.Brep], features: System.Collections.Generic.List[object]):
        holes = []
        ...
        for feature in features:
            if feature:
                if feature.elements:
                    ghenv.Component.AddRuntimeMessage(Grasshopper.Kernel.GH_RuntimeMessageLevel.Warning, "Features in the Fastener Timber Interface are applied by joints. Elements in feature definitions will be ignored")
