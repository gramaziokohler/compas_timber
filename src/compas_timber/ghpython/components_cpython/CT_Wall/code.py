...
class WallComponent(Grasshopper.Kernel.GH_ScriptInstance):
    def RunScript(self, surface: System.Collections.Generic.List[Rhino.Geometry.Brep], thickness: System.Collections.Generic.List[float], config_set: System.Collections.Generic.List[object]):
