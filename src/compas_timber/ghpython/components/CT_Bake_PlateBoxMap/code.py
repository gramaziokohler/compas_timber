...
class BakePlateBoxMap(component):
    def RunScript(self, model_list, map_size, swap_uv, layer_name, clear_layer_content, bake):
    ...
    def create_box_map(pln, sx, sy, sz, swap_uv):
        ...
        if swap_uv:
            mapping_pln.Rotate(math.radians(90), mapping_pln.XAxis)
