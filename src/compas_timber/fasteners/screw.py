...
class Screw(FastenerPart):
    ...
    def apply_fastening_features(self, elements: list) -> None:
        """Apply the fabrication features generated by this screw to the connected timber elements.

        The screw is assumed to be a cylindrical hole in the connected timber elements. The hole is centered on the
        screw's placement frame and has the same diameter as the screw.
