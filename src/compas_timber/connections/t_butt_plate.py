...
class TButtPlateJoint(TButtJoint):
    ...
    @property
    def elements(self):
        """Returns the elements used by this joint."""
        return self.beams + self.fasteners

    @property
    def beams(self):
        """Returns the beams used by this joint."""
        return [self.main_beam, self.cross_beam]

    @property
    def generated_elements(self):
        """Returns the elements generated by this joint."""
    ...
    def interactions(self):
        ...
        for fastener in self.fasteners:
            interactions.append((self.main_beam, fastener))
            interactions.append((self.cross_beam, fastener))
        return interactions
