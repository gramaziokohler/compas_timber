...
def _beam_plate_connection_candidate(element_a, element_b, max_distance):
    """Builds a :class:`~compas_timber.connections.BeamPlateJointCandidate` for a beam/plate (or beam/panel) pair, or ``None`` if their topology is unknown."""
    from compas_timber.connections.joint_candidate import BeamPlateJointCandidate  # local import: avoids a circular import (joint.py imports JointTopology from this module)
