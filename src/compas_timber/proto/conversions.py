...
# Steko-specific parts (StekoPlate, StekoSwordPlate) have no proto message yet and are not
# registered here; serializing a StekoFastener through protobuf will fail until they are added.
