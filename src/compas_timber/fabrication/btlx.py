...
class BTLxReader(object):
    ...
    def _parse_part(self, part_element):
        ...
        if element_type == "Beam":
            ...
            # TODO: Verify if plates also need ref_frame conversion
            # For now, keeping original behavior for plates
            element = Plate(frame=ref_frame, length=length, width=width, thickness=height)
