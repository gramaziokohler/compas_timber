...
class FreeContour(BTLxProcessing):
    ...
    def __init__(
        self, contour_points, associated_contour_points=None, depth=None, counter_sink=False, tool_position=AlignmentType.LEFT, depth_bounded=True, inclination=None, **kwargs
    ):
