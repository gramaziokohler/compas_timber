...
* Added alternative constructor `MachiningLimits.from_dictionary()`. 
...
* `Slot`, `Pocket`, and `Lap` now accept a `MachiningLimits` instance as the primary input instead of only a `dict`.
