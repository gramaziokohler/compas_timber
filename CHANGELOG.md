...
### Added
* Added `extend_beam_to_plane`, `angle_and_dot_product_main_beam_and_cross_beam`, `parse_cross_beams_and_main_beams_from_cluster` functions in `compas_timber.connections.utilities`.
